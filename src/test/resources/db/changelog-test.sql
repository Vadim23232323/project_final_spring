...
--changeset DUBOVSKIY:init_schema
...
--changeset DUBOVSKIY:populate_data
--============ References =================
...
values ('assigned', 'Assigned', 6, '1'),
       ('three_days_before_deadline', 'three_days_before_deadline', 6, '2'),
...
--changeset DUBOVSKIY:change_backtracking_tables
...
--changeset DUBOVSKIY:change_task_status_reference
...
--changeset DUBOVSKIY:users_add_on_delete_cascade
...
--changeset DUBOVSKIY:change_user_type_reference
...
--changeset DUBOVSKIY:refactor_reference_aux
...
--changeset komarov:change_UK_USER_BELONG
